...
export default function RulesForm(props) {
  ...
  return (
    <div className="mt-3">
      ...
      <button className="btn btn-purple mr-4" onClick={addRule}>
        Add Rule
      </button>
      <button className="btn btn-red" onClick={deleteRule}>
        Delete Rule
      </button>
      <button className="btn btn-green float-right" onClick={submitData}>
        Save Rules
      </button>
    </div>
  );
